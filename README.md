...
3. **Bayesian Prediction Engine:** A probabilistic model that generates a mean cycle length prediction alongside a calibrated confidence interval (e.g., $29.5 \pm 4.2 \text{ days}$).
...
| Parameter / Feature | Value / Distribution (Synthetic Data) | Source Literature |
| :--- | :--- | :--- |
| **Population Baseline Cycle Length** | $\mathcal{N}(30.17, 6.88^2)$ | Bull et al. (2019) |
| **Underweight BMI Irregularity Rate** | $31.8\%$ ($\text{BMI} < 18.5$) | Patel (2023) / Fitriani (2019) | 
| **Normal BMI Irregularity Rate** | $18.4\%$ ($18.5 \le \text{BMI} \le 24.9$) | Patel (2023) / Fitriani (2019) |
| **Overweight BMI Irregularity Rate** | $26.6\%$ ($\text{BMI} > 25.0$) | Patel (2023) / Fitriani (2019) |
| **Dysmenorrhea Rate (Low BMI)** | $90.3\%$ ($\text{BMI} < 18.5$) | Patel (2023) | 
| **Dysmenorrhea Rate (Normal BMI)** | $30.7\%$ ($18.5 \le \text{BMI} \le 24.9$) | Patel (2023) | 
